...
const statusPresentations: Readonly<Record<string, Readonly<{ label: string; tone: StatusTone }>>> = {
  ...
  ACTIVATING: { label: "활성화 중", tone: "neutral" },
  ...
  DISABLED: { label: "비활성화됨", tone: "neutral" },
  ...
  PENDING_SUBMIT: { label: "제출 대기", tone: "neutral" },
  ...
  RECONCILING: { label: "대사 중", tone: "neutral" },
  ...
  UNKNOWN_OUTCOME: { label: "결과 확인 중", tone: "danger" },
...
const diagnosticLabels: Readonly<Record<string, string>> = {
  ...
  ACCOUNT_GENERATION_NOT_ACTIVE: "Testnet 계정 세대가 아직 활성화되지 않음",
  ...
  TESTNET_DEFAULT_OFF: "Spot Testnet 기본 차단",
  SUBMISSION_UNKNOWN: "주문 제출 결과를 확인할 수 없음",
  RESET_SUSPECTED: "Testnet 계정 초기화 의심",
  USER_DATA_GAP: "사용자 데이터 누락",
  GATEWAY_DRIFT: "게이트웨이 구성 불일치",
  GATEWAY_ACTIVATING: "게이트웨이가 초기 대사를 진행 중임",
  RECONCILIATION_NOT_HEALTHY: "Testnet 대사가 아직 정상 상태가 아님",
