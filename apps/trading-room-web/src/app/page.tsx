...
const destinations = [
  ...
  ["Spot Testnet 운영", "/testnet", "기본 차단된 외부 Testnet 경계와 별도 승인·대사 상태를 확인합니다."],
...
export default function TradingRoomPage() {
  return (
    <>
      <PageHeading eyebrow="8단계 · 안전한 Testnet 확장" title="우주 트레이딩룸">
        근거 기반 연구와 사람의 승인을 거치는 모의투자 및 Spot Testnet 환경입니다. 권위 데이터가 없거나 오래되면 화면에 보류로 표시됩니다.
      </PageHeading>
      <MarketStatus />
