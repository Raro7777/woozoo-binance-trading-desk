...
const outputs = new Map([
  ...
  [resolve(root, "packages/typescript/contract-bindings/src/generated.ts"), `${tsBindings}${marketTsBindings}${domainTsBindings}${strictEvidenceTsBindings}`],
  [
    resolve(root, "packages/python/platform-core/src/platform_core/generated_contracts.py"),
    `${strictPyBindings}${evidencePyBindings}`
      .replace(
